...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index.php?page_layout=suapt&id=<?php echo $row['MaPT'];?>">Sửa</a>
                            </td>
                            <td>
                                <a onclick="return Del('<?php echo $row['TenPT'];?>')" href="index.php?page_layout=xoapt&id=<?php echo $row['MaPT'];?>">Xóa</a>
            ...
            <a class="btn btn-primary"href="index.php?page_layout=thempt">Thêm mới</a>
        </div>
    </div>
</div>
<script>
